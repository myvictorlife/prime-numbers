...
/**
 * The Sieve of Eratosthenes is a simple algorithm for finding all of
 * the prime numbers up to a certain limit (or between two numbers).
 * @param max Maximum limit
 */
const findingAllOfThePrimeNumbers = max => {
...
export default findingAllOfThePrimeNumbers;
